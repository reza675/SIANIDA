...
import Controller.BukuPendingController;
 ...
 * @author ASUS
 */
public class BukuPendingView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Peminjaman Pending");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 80, 410, -1));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BukuPendingView("Admin").setVisible(true);
            }
        });
    }

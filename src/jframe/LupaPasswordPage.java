...
public class LupaPasswordPage extends javax.swing.JFrame {
     ...
     */
    public LupaPasswordPage(String email) {
        this.email = email;
        initComponents();
    }
    ...
    String newPassword = new String(text_NewPass.getPassword());
    String confirmPassword = new String(text_ConfirmPass.getPassword());
    ...
    try (Connection con = DBConnection.getConnection()) {
        ...
        ps.setString(1, newPassword); // Gunakan hashing di produksi!
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(this, "Terjadi kesalahan saat mengganti password.");
    }
